...
INSERT INTO student43.user_dim (user_key,user_id,first_name,last_name,address,zipcode,date_from,date_to,created_date,updated_date) VALUES
	 (1000,'b0cc9fde-a29a-498e-824f-e52399991beb','john','doe','world','10027','1990-01-15','1990-03-01','1900-01-15 00:00:00.000','1900-01-15 10:00:00.000'),
	 (1100,'b0cc9fde-a29a-498e-824f-e52399991beb','john','doe','world','1002777','1990-01-15','1990-03-01','1900-01-14 00:00:00.000','1900-01-15 00:00:00.000'),
	 (1200,'b0cc9fde-a29a-498e-824f-e52399991beb','john','doe','world','10012','1990-01-01','1990-02-01','1900-01-01 00:00:00.000','1900-01-01 00:00:00.000');
...
select 
	...
	now() as upd_dttm
from rank_tmp
where rank not in ((select max(rank) from rank_tmp), 1)
union 
select 
	user_id,
	first_name,
...
Вопросы:
1) Выравнивание истории - должны изменяться date_from/date_to с ранком между первым и последним?